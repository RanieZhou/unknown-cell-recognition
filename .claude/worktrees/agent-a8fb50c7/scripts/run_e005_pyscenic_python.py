...
OUTPUT_DIR_V1 = os.path.join(PROJECT_DIR, "outputs", "E005")     # v1 root (TSV/adj)
DATA_DIR = os.path.join(PROJECT_DIR, "data", "pyscenic_dbs")
os.makedirs(OUTPUT_DIR, exist_ok=True)

# 读取 v1 的表达矩阵和 GRN（基因集相同，无需重导出）
EXPR_TSV = os.path.join(OUTPUT_DIR_V1, "E005_train_known_expr.tsv")
...
# GRN adjacencies 直接用 v1 的（基因集相同，结果一致）
GRN_ADJ = os.path.join(OUTPUT_DIR_V1, "E005_grn_adjacencies.tsv")
# CTX 和 AUCell 输出到 v2
